...
const Videos = () => {
  // Play button
  const playButton = (
    <div className="h-[15px] w-[25px] flex justify-center items-center bg-seashell/20 rounded-[4px] backdrop-blur-[0.5px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-milk-white">
  ...
  return (
    <div className="h-full">
      ...
      <div className="h-[150px] w-[160px] sm:h-[240px] sm:w-[270px] md:h-[320px] md:w-[350px] lg:h-full lg:w-[400px]">
        <div className="relative">
          ...
          <div className="h-[50px] w-[70px] flex justify-center items-center bg-seashell/20 rounded-[4px] backdrop-blur-[0.5px] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border border-milk-white">
        ...
        <p className="font-medium text-fun-blue pt-2 w-full text-end">More +</p>
      </div>
    </div>
  );
};
